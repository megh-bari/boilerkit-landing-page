...
export default function Footer() {
  return (
    <footer className="border-t py-12 px-4 backdrop-blur-md bg-zinc-950/50 border-white/10 font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 justify-items-center mx-auto ">
          ...
          <div className="col-span-1 md:col-span-1 text-center md:text-left">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">BoilerKit</span>
            </div>
